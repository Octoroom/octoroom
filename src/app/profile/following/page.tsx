// src/app/profile/following/page.tsx
'use client';
  ...
  return (
    ...
    <div className="p-4 sm:p-6 pb-20">
      ...
      <div className="flex items-center justify-between mb-6 sticky top-0 bg-white/80 backdrop-blur-md z-10 py-2 -mx-4 px-4 sm:-mx-6 sm:px-6">
        <h1 className="text-2xl font-black text-gray-900">我关注的人</h1>
        <button 
          onClick={() => router.back()} 
      ...
      {loading ? (
        ...
        <div className="text-center text-gray-500 py-10 bg-white rounded-2xl border border-dashed border-gray-300">
          还没有关注任何人，去<Link href="/discover" className="text-octo-orange font-bold mx-1 hover:underline">发现博主</Link>看看？
        </div>
      ) : (
