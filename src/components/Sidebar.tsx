...
export default function Sidebar() {
  ...
  return (
    <nav className="hidden md:flex w-[240px] flex-col p-4 sticky top-0 h-screen border-r border-gray-100 bg-octo-cream/50 backdrop-blur-sm relative z-50">
      
      {isSignedIn && (
        <div className="absolute top-0 right-full w-[280px] h-screen overflow-y-auto scrollbar-hide pr-8 pt-4 pb-10 flex flex-col">
          ...
          <div className="flex flex-col space-y-6">
            {isLoadingCities ? (
              ...
              popularCities.map((city, index) => (
                <Link key={city.id} href={`/companions?city=${city.slug}`} className={`flex flex-col group cursor-pointer px-1 flex-shrink-0 ${index === popularCities.length - 1 ? 'pb-8' : ''}`}>
      ...
      <div className="mb-6 px-4 py-2 flex-shrink-0">
        <h1 className="text-2xl font-black text-octo-orange italic tracking-tighter">OctoRoom</h1>
      </div>

      <div className="flex-1 overflow-y-auto space-y-1.5 pb-4 scrollbar-hide relative z-10">
        <Link href="/" className="flex items-center space-x-4 px-4 py-2.5 rounded-full hover:bg-gray-200/50 transition-all text-[16px] font-medium text-gray-900 w-fit pr-6">
        ...
        {isSignedIn && (
          <>
            <Link href="/discover" className="flex items-center space-x-4 px-4 py-2.5 rounded-full hover:bg-gray-200/50 transition-all text-[16px] font-medium text-gray-900 w-fit pr-6">
            ...
            <Link href="/companions" className="flex items-center space-x-4 px-4 py-2.5 rounded-full hover:bg-gray-200/50 transition-all text-[16px] font-medium text-gray-900 w-fit pr-6">
            ...
            <Link href="/rooms" className="flex items-center space-x-4 px-4 py-2.5 rounded-full hover:bg-gray-200/50 transition-all text-[16px] font-medium text-gray-900 w-fit pr-6">
            ...
            <Link href="/profile" className="flex items-center space-x-4 px-4 py-2.5 rounded-full hover:bg-gray-200/50 transition-all text-[16px] font-medium text-gray-900 w-fit pr-6">
            ...
            <Link href="/albums" className="flex items-center space-x-4 px-4 py-2.5 rounded-full hover:bg-gray-200/50 transition-all text-[16px] font-medium text-gray-900 w-fit pr-6">
              <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6"><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.409a2.25 2.25 0 013.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 001.5-1.5V6a1.5 1.5 0 00-1.5-1.5H3.75A1.5 1.5 0 002.25 6v12a1.5 1.5 0 001.5 1.5zm10.5-11.25h.008v.008h-.008V8.25zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" /></svg>
              <span>我的相册</span>
            </Link>

            <Link href="/my-rooms" className="flex items-center space-x-4 px-4 py-2.5 rounded-full hover:bg-gray-200/50 transition-all text-[16px] font-medium text-gray-900 w-fit pr-6">
            ...
            <Link href="/my-comments" className="flex items-center space-x-4 px-4 py-2.5 rounded-full hover:bg-gray-200/50 transition-all text-[16px] font-medium text-gray-900 w-fit pr-6">
              <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            <Link href="/my-marks" className="flex items-center space-x-4 px-4 py-2.5 rounded-full hover:bg-gray-200/50 transition-all text-[16px] font-medium text-gray-900 w-fit pr-6">
              <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            <Link href="/my-bookings" className="flex items-center space-x-4 px-4 py-2.5 rounded-full hover:bg-gray-200/50 transition-all text-[16px] font-medium text-gray-900 w-fit pr-6">
              <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            {/* 🌟 橙色未读小红点 */}
            <Link href="/messages" className="flex items-center space-x-4 px-4 py-2.5 rounded-full hover:bg-gray-200/50 transition-all text-[16px] font-medium text-gray-900 w-fit pr-6 group relative">
      ...
      {isSignedIn && (
        <div className="pt-4 mt-auto flex-shrink-0 relative z-10">
          <button onClick={handleSignOut} className="flex items-center space-x-4 px-4 py-2.5 rounded-full hover:bg-red-50 hover:text-red-600 transition-all text-base font-medium text-gray-500 group w-fit pr-6">
